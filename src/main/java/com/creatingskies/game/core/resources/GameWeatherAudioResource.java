...
public class GameWeatherAudioResource implements GameResource{

	private static final String audioFileName = "weatheraudio.mp3";
	private String audioDir;
	private CyclicBarrier cyclicBarrier;
	private AudioClip audioClip;
	
	public GameWeatherAudioResource(final CyclicBarrier cyclicBarrier,final Game game, final String sessionId) {
		this.cyclicBarrier = cyclicBarrier;
		if(game != null && game.getAudio() != null){
			audioDir = "game/tmp/"+sessionId+"/weather/audio/";
